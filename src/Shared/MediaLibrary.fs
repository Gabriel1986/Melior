...
module Partitions =
    ...
    let [<Literal>] Deposits = "Deposits"
    let [<Literal>] DepositRequests = "DepositRequests"
...
module MimeTypes =
    ...
    let getMimeType (fileExtension: string) =
        match mimeTypeDictionary.TryGetValue(fileExtension.ToLower().TrimStart('.')) with
        | true, mimeType -> mimeType
